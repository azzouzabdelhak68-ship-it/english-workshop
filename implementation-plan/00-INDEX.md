...
| F7 AI Chat Room | ✅ Rebuilt v3 | Full rebuild per `AI_ROOM_PLAN.md` (1698-line roadmap): draft persistence (`ai_chat_sessions` + RLS, migration 0003 — **apply via dashboard/db push**), drafts menu w/ rename/duplicate/delete, inline YouTube preview facade, per-activity AI edit (fn Mode-2), focus presets, timing strip, print worksheet, copy, autosave+resume, empty/skeleton states; legacy L01–L23 preserved verbatim; free-tier safe (no google_search tool); i18n EN+AR complete |
